...
class PaymentProvider(models.Model):
    ...
    def _multisafepay_make_request(self, endpoint, data=None, method='POST'):
        ...
        module_version = self.env.ref('base.module_payment_integration').installed_version
        headers = {
            "Accept": "application/json",
            "Authorization": f'Bearer {self.multisafepay_website_key}',
        ...
        try:
            ...
            _logger.exception("unable to communicate with Multisafepay: %s", url)
